"""
test_predict_model.py — Tests para {{ cookiecutter.project_slug }}/models/predict_model.py
"""
import numpy as np
import pandas as pd
import pytest
...
from {{ cookiecutter.project_slug }}.models.predict_model import (
    evaluate_models,
    predict_new,
    predict_proba_new,
...
from {{ cookiecutter.project_slug }}.models.predict_model import evaluate_models, predict_new
from {{ cookiecutter.project_slug }}.models.train_model import MLP, train_models
