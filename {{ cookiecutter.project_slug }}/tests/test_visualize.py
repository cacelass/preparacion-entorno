"""
test_visualize.py — Tests para {{ cookiecutter.project_slug }}/visualization/visualize.py
"""
import numpy as np
import pandas as pd
import pytest
...
def test_plot_umap_skips_if_not_installed(patch_paths, capsys):
    ...
    try:
        from {{ cookiecutter.project_slug }}.visualization.visualize import plot_umap
