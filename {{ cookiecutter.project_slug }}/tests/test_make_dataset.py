"""
test_make_dataset.py — Tests para {{ cookiecutter.project_slug }}/data/make_dataset.py
"""
import pandas as pd
import numpy as np
import pytest
...
def test_load_data_polars_reads_csv(patch_paths):
    ...
    from {{ cookiecutter.project_slug }}.data.make_dataset import load_data_polars, polars_to_pandas
